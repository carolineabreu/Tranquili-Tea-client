...
//             </div>
//             <p>Name</p>
//             <p className="leading-relaxed">{TeaInfo.description}</p>
//             <p>Category: {TeaInfo.category}</p>
//             <p>Origin: {TeaInfo.origin}</p>
//             <p>Brew: {TeaInfo.brew}</p>
//             <p>Temperature: {TeaInfo.temperature}</p>
//             <p>Caffeine: {TeaInfo.caffeine}</p>
//             <p>Flavour: {TeaInfo.flavour}</p>
//             <p>Ingredients: {TeaInfo.ingredients}</p>
...
//               <div className="flex">
//                 <p className="font-bold text-xl">{TeaInfo.price}</p>
//                 <button
