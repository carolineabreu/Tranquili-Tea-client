      ...
      <div className="mx-auto max-w-2xl py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
        ...
        <div>
          <Link to="/carrinho">
            <button
              type="button"
              className=" top-5 left-0 h-30 w-15 text-white bg-indigo-700 hover:bg-indigo-900 flex justify-end focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-3xl text-sm px-5 py-2.5 text-center items-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            >
              <svg
                aria-hidden="true"
