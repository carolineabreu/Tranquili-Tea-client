      ...
      <div class="container px-5 py-24 mx-auto">
        <div class="lg:w-4/5 mx-auto flex flex-wrap">
          ...
          <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <p>Name</p>
            <p class="leading-relaxed">{teaDetail.description}</p>
            ...
            <div class="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
              <div class="flex">
                ...
                <button class="border-2 border-green-200  bg-green-300 rounded-full w-6 h-6 focus:outline-none"></button>
              </div>
            ...
            <div class="flex mt-6 items-center pb-5 ">
              <div class="flex">
                <p class="font-bold text-xl">{teaDetail.price}</p>
                <button
            ...
            <div class="flex">
              <button class="flex ml-auto text-white bg-green-400 border-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded">
                Button
              </button>
              <button class="rounded-full w-10 h-10 bg-gray-200 p-0 border-0 inline-flex items-center justify-center text-purple-500 ml-4">
                <svg
                  fill="currentColor"
                  stroke-linecap="round"
                  stroke-linejoin="round"
