...
<div className="w-60 p-2 bg-white rounded-xl transform transition-all hover:-translate-y-2 duration-300 shadow-lg hover:shadow-2xl">
  ...
  <div className="m-2">
    <Link to="/Teas" className="text-black bg-purple-300 px-3 py-1 rounded-md hover:bg-purple-700"
    >
      Shop Now
    </Link>
  </div>
...
<div className="w-60 p-2 bg-white rounded-xl transform transition-all hover:-translate-y-2 duration-300 shadow-lg hover:shadow-2xl">
  ...
  <div className="p-2">
    ...
    <p className="text-sm text-gray-600">
    Chamomile is widely recognized as Link mild tranquilizer and sleep-inducer. It is thought that chamomile may increase brain neurotransmitter activity and thereby have positive effects on mood and anxiety. </p>
  </div>
  <div className="m-2">
    <Link to="/Teas" className="text-black bg-purple-300  px-3 py-1 rounded-md hover:bg-purple-700"
    >
