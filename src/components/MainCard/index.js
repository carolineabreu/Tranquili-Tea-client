          ...
          <div className="bg-white border-l-2 shadow-sm border-deep-purple-accent-400">
            <div className="h-full p-5 border border-l-0 rounded-r">
              ...
              <p className="text-sm text-gray-900">
                ...
                know it is. So, if you have been struggling with sleep or you’re
                feeling stressed at work, don’t worry. We have specific kinds of
                tea that can help you. For some situations, green tea may be
                ideal, while for others, chamomile tea works better. Let us help
                you find the right blend for your current state of mind.
              </p>
              ...
              <div className="grid gap-5 row-gap-8 sm:grid-cols-2">
                <div className="bg-white border-l-2 shadow-sm border-deep-purple-accent-400">
                  <div className="h-full p-5 border border-l-0 rounded-r">
                    ...
                    <p className="text-sm text-gray-900">
                      There’s tea for every mood! Isn’t that the best thing
                      ever? We know it is. So, if you have been struggling with
                      sleep or you’re feeling stressed at work, don’t worry. We
                      have specific kinds of tea that can help you. For some
                      situations, green tea may be ideal, while for others,
                      chamomile tea works better. Let us help you find the right
                      blend for your current state of mind.
                    </p>
                  </div>
                </div>
              </div>
              <div className="bg-white border-l-4 shadow-sm border-deep-purple-accent-400">
                <div className="h-full p-5 border border-l-0 rounded-r">
                  ...
                  <p className="text-sm text-gray-900">
                    ...
                    organic, sustainable and like-minded suppliers who truly
                    care about how they treat people and the environment.
                  </p>
                </div>
              </div>
            </div>
