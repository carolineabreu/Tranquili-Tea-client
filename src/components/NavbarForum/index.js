        ...
        <div className="hidden sm:block flex-shrink flex-grow-0 justify-start px-2">
          <div className="inline-block">
            <div className="inline-flex items-center max-w-full">
              ...
              <div className="px-4">
              <a className="inline-block px-4 py-2 px-3bg bg-white w-50 hover:bg-blue-200 text-green-400 font-semibold hover:text-white border border-black-900 hover:border-transparent rounded-full" href="#">
        ...
        <div className="flex-initial">
          <div className="flex justify-end items-center relative">
            <div className="flex mr-8 items-center">
              <a className="inline-block py-2  w-50 bg-white hover:bg-blue-100 text-green-400  hover:text-white px-4 border border-blue-500s hover:border-transparent rounded-full" href="#">
