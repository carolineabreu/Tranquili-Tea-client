          ...
          <div className="flex justify-end items-center relative">
            ...
            <div className="block">
              <div className="inline relative">
                <button type="button" className="inline-flex items-center relative border-blue-500 px-2 border rounded-full hover:shadow-lg">
                    
                  <div className="pl-1 text-blue-500 fill-current ">
                  ...
                  <div className="block flex-grow-0 flex-shrink-0 h-10 w-12 pl-5  text-blue-500 fill-current ">
